...
<head>
    <meta charset="UTF-8">
    <title>Login / Register HOME.MX</title>
...
<div class="container-form">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            <div class="welcome-form"><h1>Bienvenido</h1><h2>HOME.MX</h2></div>
            ...
            <div class="phone line-input">
                <label class="lnr lnr-envelope"></label>
                <input type="text" placeholder="telefono" name="telefono">
            </div>
            <div class="calendary line-input">
                <label class="lnr lnr-envelope"></label>
                <input type="text" placeholder="fecha alta" name="fechaalta">
            </div>
